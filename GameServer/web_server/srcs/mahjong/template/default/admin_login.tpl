        ...
        <div class="login-main">
            <form action="{{info['submitUrl']}}" class="layui-form" method="post">
                ...
                <div class="login-code-box" style='text-align:center'>
                    <button class="layui-btn  layui-btn-normal" lay-submit="" lay-filter="login" style="border-radius:4px; border-color: #357ebd;background-color: #428bca;color: #fff;width:150px;font-size:20px">
                        登录
                    </button>
                </div>
                <div class="login-code-box" style='text-align:center;margin-top:15px'>
                    %if message:
                        <span class='error-message' style='color:#d10707;font-size:15px;'>{{message}}</span>
                    %end
                </div>
            </form>        
        </div>
