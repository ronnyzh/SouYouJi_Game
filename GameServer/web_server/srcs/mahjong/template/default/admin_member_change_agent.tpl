    ...
    <div class='content' id="recharge_app">
        <form class='form-horizontal group-border-dashed' @submit="onSubmit" action="{{info['submitUrl']}}"
            ...
            <table class='table config-table'>
                <tr>
                    <td width='20%' class='table-title' style="background-color:#d9edf7;font-size:20px">转移公会</td>
                </tr>
                <tr>
                    <td>
                        <table class='table config-table' border='1'>
                            ...
                            <tr>
                                <td class='table-title'>转移公会</td>
                                <td>
                                    <input type='text' value=""
                                           style='width:100%;float:left'
                                           name='changeId' data-rules="{required:true}" class="form-control">
                                </td>
                            </tr>
                            </tr>
                        </table>
