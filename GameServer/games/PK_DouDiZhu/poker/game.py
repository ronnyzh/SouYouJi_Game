...
RESET_PROTO_LIST = ['S_C_DealCards', 'S_C_RobLandlord', 'S_C_RobLandlordResult', 'S_C_ScoreData']
...
class Game(PublicGame):
    ...
    def resetSetData(self):
        ...
        self.maxAllNotCallCount = 0  # 最大流局次数,达到将会随机庄 如果是0则是无限次
