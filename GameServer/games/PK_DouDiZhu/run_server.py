...
_opt("-p", "--port", action="store", type="int", default=11000, help="Service port.")
_opt("-i", "--address", action="store", type="string", default="192.168.50.2", help="Service ip.")
_opt("-n", "--name", action="store", type="string", default="poker_fightTheLandlord", help="Game name tag.")
