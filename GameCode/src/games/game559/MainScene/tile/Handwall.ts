                ...
                return new Vuet({
                    ...
                    method: {
                        ...
                        getMaxCardId: function () {
                            ...
                            var maxCardId = rfa.utils.getCardNumber(this.dataList[0]);

                            for (var i = 1; i < this.dataList.length; ++i) {
                                if (rfa.utils.getCardNumber(this.dataList[i]) > maxCardId)
                                    maxCardId = rfa.utils.getCardNumber(this.dataList[i]);
                            }
                            return maxCardId;
                        },
                        ...
                        update: function (tileList, isShowEffect?, callback?, isfapai = false) {
                            ...
                            this.dataList = tileList.concat();

                        },

                        //批量设置牌面  listtype 0手牌  1是出的牌
                                    ...
                                    Method.setTimeout(function () {
                                        ...
                                        conList._children.forEach((item, index, array) => {
                                            ...
                                            Method.setTimeout(function () {
                                                ...
                                                //if (array.length == 16 && listtype == 0 && localSide == 0)
                        ...
                        refreshTile: function () {
                            ...
                            self.tileList.forEach(function (tile) {
                                ...
                                switch (true) {
                                    case (self.disabledList.indexOf(rfa.utils.getCardNumber(tile.data)) !== -1):
                        ...
                        sortCardListFunc: function (card1, card2) {
                            return rfa.utils.compareCard(card1, card2);
                        },
                        //------
                        ...
                        setTileStage: function (tile, type) {
                            ...
                            switch (type) {
                                ...
                                case (TILE_STAGE.DISABLED):
                                    controller.setSelectedPage(TILE_STAGE.NORMAL);
                        ...
                        initTileByData: function (tile, rank, callback?) {
                            ...
                            // var cache = Control.Tilepool.tileCache['559'+rank];
                            ...
                            //     setTile(tex);
                            //     // Control.Tilepool.tileCache['559'+v] = tex;
                            // }, [rank]));
                        },
