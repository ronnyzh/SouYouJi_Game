module G548 {
    ...
    export let S_C_STARTBID = 0x00006027;//----开始下注 
    export let S_C_MATCH_TIME = 0x00006028;//----匹配时间




    export class G548NetHandler extends PartyNetHandler {
        ...
        getGameProtoDataList() {
            ...
            let baccaratMapList = [
                ...
                [S_C_STARTBID,'S_C_StartBid'],
                [S_C_MATCH_TIME,'S_C_MatchTime']
        ...
        enterGame(sid, gameid ,cb)
        {
            ...
            this.createOnceSequenceListener(G548.S_C_CONNECTED, cb);
        }

        sendChangeRoom(cb?) {
            this.sendData(ProtoKeyParty.C_S_CHANGE_ROOM);
            // if (cb)
            //     this.createOnceSequenceListener(G548.S_C_EXIT_ROOM_RESULT, cb)
        }
        ...
        sendExitRoom(cb?) {
            ...
            // if (cb)
            //     this.createOnceListener(G548.S_C_EXIT_ROOM_RESULT, cb);
        }
