    ...
    export namespace GControl {
        ...
        export let createPlayer = function (localSide) {
            ...
            let component = {
                ...
                //抢地主
                'tag_landlord_1': view.getChildInGroup('tag_landlord_1', con),
                'tag_landlord_2': view.getChildInGroup('tag_landlord_2', con),
                'tag_landlord_3': view.getChildInGroup('tag_landlord_3', con),
                'tag_landlord_no': view.getChildInGroup('tag_landlord_no', con),
                'tag_landlord_yes': view.getChildInGroup('tag_landlord_yes', con),
